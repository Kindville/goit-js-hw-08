...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o="feedback-form-state",r={},a=document.querySelector(".feedback-form"),n=document.querySelector("textarea");function l(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(o),console.log(r)}function c(e){const t=e.target.value;console.log(t),r[e.target.name]=e.target.value,localStorage.setItem(o,JSON.stringify(r))}function u(){const e=localStorage.getItem(o);e&&(console.log(e),n.value=e)}a.addEventListener("submit",l),n.addEventListener("input",(0,e.default)(c,500)),u();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.dd13ada7.js.map